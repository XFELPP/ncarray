...
### Added
- Similar runtime JIT compilation strategy for host-side expressions. Provide a rudimentary compilation phase and using `asmjit` output functions for linearizable expression tapes.
